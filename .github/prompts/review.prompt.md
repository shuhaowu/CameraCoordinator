...
Once the review is completed, the review comments should be outputted into a markdown format into `notes/CODE_REVIEW.md`. There should be two sections: an overall comment and inline comments:
